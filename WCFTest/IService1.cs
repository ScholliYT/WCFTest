...
namespace WCFTest
{
    ...
    // Sie können im Projekt XSD-Dateien hinzufügen. Sie können nach dem Erstellen des Projekts dort definierte Datentypen über den Namespace "WCFTest.ContractType" direkt verwenden.
    [DataContract]
